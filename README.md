...
The present study aims to provide maps generated by the [Kernel Density Function](https://doc.arcgis.com/en/arcgis-online/analyze/kernel-density-global-function.htm) on access to healthy food in slums and urban communities, through the collection, processing, geocoding, and classification of [CNPJ](https://en.wikipedia.org/wiki/CNPJ) data from both the Brazilian Federal Revenue Service ([RFB](https://www.gov.br/receitafederal/)) and the Annual Social Information Report ([RAIS](https://www.rais.gov.br/)) of the Ministry of Labor and Employment ([MTE](https://www.gov.br/trabalho-e-emprego)), as well as data on establishments classified as healthy food retailers from OpenStreetMap ([OSM](https://www.openstreetmap.org/#map=4/-15.13/-53.19)), from the [Overpass API](https://wiki.openstreetmap.org/wiki/Overpass_API). The classification of food healthiness follows the [Locais-Nova](https://doi.org/10.1590/S2237-96222025v34.20240361.en) study, using Group 0 (G0) — which is not part of the original classification, but rather a subgroup within the G1 + G2 group — comprising establishments that sell exclusively healthy foods that should be part of the population's diet.

The report is available [here](hhttps://cem-usp.github.io/kernel-accessibility/).
